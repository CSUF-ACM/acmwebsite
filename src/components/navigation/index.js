    ...
    return <nav className="uk-navbar-container uk-navbar-primary" uk-navbar=""
        ...
        <div className='uk-navbar-right'>
            <ul className="uk-navbar-nav uk-visible@s">
                ...
                <li className={name === "events" ? "uk-active" : ""}><a href="/events" className="uk-button uk-button-text">Events Calendar</a></li>
                <li className={name === "subscribe" ? "uk-active" : ""}><Link to="/subscribe" className="uk-button uk-button-text" onClick={Scroll.animateScroll.scrollToTop()}>Mailing List</Link></li>
                <li className={name === "board" ? "uk-active" : ""}><Link to="/board" className="uk-button uk-button-text" onClick={Scroll.animateScroll.scrollToTop()}>Board Members</Link></li>
                <li className={name === "contact" ? "uk-active" : ""}><Link to="/contact" className="uk-button uk-button-text">Contact Us</Link></li>
            </ul>
            <div className="uk-navbar-right uk-hidden@s"><div className='uk-navbar-toggle' uk-navbar-toggle-icon=""
